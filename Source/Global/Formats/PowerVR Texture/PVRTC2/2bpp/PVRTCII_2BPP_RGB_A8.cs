...
{
TraceLogger.WriteLine("• PVRTCII-2BPP-RGB + A8 Texture Decode:");
TraceLogger.WriteLine();

var decImg = PVRII_2BPP_Decoder.Decode(reader, width, height, false);
...
{
TraceLogger.WriteLine("• PVRTCII-2BPP-RGB + A8 Texture Encode:");
TraceLogger.WriteLine();

_ = PVRII_2BPP_Encoder.Encode(writer, ref image, false);
