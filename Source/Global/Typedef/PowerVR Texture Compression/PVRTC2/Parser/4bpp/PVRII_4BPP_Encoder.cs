...
public static unsafe class PVRII_4BPP_Encoder
{
// Encode Packet

private static PVR2Packet4BPP EncodePacket(TextureColor* pixels, int width, int blockX, int blockY,
                                           bool useAlpha)
{

EncodePx(pixels, width, blockX, blockY, false, useAlpha,
...
private static void InitPackets(Span<PVR2Packet4BPP> packets, TextureColor* pixels, int width,
...
private static NativeMemoryOwner<PVR2Packet4BPP> EncodeColor(TextureColor* pixels, int width, int height,
                                                             bool useAlpha)
{
...
NativeMemoryOwner<PVR2Packet4BPP> pOwner = new(totalBlocks);
